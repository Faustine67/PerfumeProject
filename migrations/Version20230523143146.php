 ...
 */
final class Version20230523143146 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notes (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE note_de_fond ADD notes_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE note_de_fond ADD CONSTRAINT FK_6D2E724BFC56F556 FOREIGN KEY (notes_id) REFERENCES notes (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE note_de_coeur ADD CONSTRAINT FK_1A060A76FC56F556 FOREIGN KEY (notes_id) REFERENCES notes (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE note_de_tete ADD CONSTRAINT FK_5D83A2C4FC56F556 FOREIGN KEY (notes_id) REFERENCES notes (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
