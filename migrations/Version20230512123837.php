 ...
 */
final class Version20230512123837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE parfum_note_de_fond (parfum_id INT NOT NULL, note_de_fond_id INT NOT NULL, INDEX IDX_46FA610ACECF0658 (parfum_id), INDEX IDX_46FA610ADB51B1C7 (note_de_fond_id), PRIMARY KEY(parfum_id, note_de_fond_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE parfum_note_de_fond ADD CONSTRAINT FK_46FA610ACECF0658 FOREIGN KEY (parfum_id) REFERENCES parfum (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE parfum_note_de_fond ADD CONSTRAINT FK_46FA610ADB51B1C7 FOREIGN KEY (note_de_fond_id) REFERENCES note_de_fond (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parfum_note_de_fond DROP FOREIGN KEY FK_46FA610ACECF0658');
        $this->addSql('ALTER TABLE parfum_note_de_fond DROP FOREIGN KEY FK_46FA610ADB51B1C7');
        ...
        $this->addSql('DROP TABLE parfum_note_de_fond');
